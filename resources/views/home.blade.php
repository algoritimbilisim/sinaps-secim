...
<head>
  ...
  =====================================-->
    ...
    <link rel="stylesheet"
        href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.4.0/css/fontawesome.min.css">
    <link rel="stylesheet" href="plugins/icofont/icofont.css">
    <link rel="stylesheet" href="plugins/slick-carousel/slick/slick.css">
    <link rel="stylesheet" href="plugins/slick-carousel/slick/slick-theme.css">

    <!-- Main Stylesheets -->
    <link rel="stylesheet" href="css/themes/{{ setting('site.theme') }}.css">
...
<body id="top" class="{{ setting('site.theme') }}">
        ...
        <nav class="navbar navbar-expand-lg navigation" id="navbar">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarmain">
                    ...
                    {{ menu('site_main', setting('site.menu_type')) }}
                </div>
            </div>
        </nav>
    </header>
                    ...
                    <div class="widget mb-5 mb-lg-0">
                        ...
                        <ul class="list-inline footer-socials mt-4">
                            <li class="list-inline-item">
                                <a href="https://www.facebook.com/Algoritim Informatics"><i
                                        class="icofont-facebook"></i></a>
                            </li>
                            <li class="list-inline-item">
                                <a href="https://twitter.com/Algoritim Informatics"><i
                                        class="icofont-twitter"></i></a>
                            </li>
                            <li class="list-inline-item">
                                <a href="https://www.pinterest.com/Algoritim Informatics/"><i
                    ...
                    <div class="col-lg-6">
                        <div class="copyright">
                            Copyright &copy; 2021, Designed &amp; Developed by <a
                                href="https://Algoritim Informatics.com/">Algoritim Informatics</a>
                        </div>
                    </div>
                    <div class="col-lg-6">
    ...
    Component Scripts
    =====================================-->
    <script src="js/components/slider/slider1.js"></script>
